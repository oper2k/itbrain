              ...
              children: [
                  ...
                  child: FFButtonWidget(
                    onPressed: () async {
                      await currentUserReference!.update({
                        ...mapToFirestore(
                          {
                            'purchasedMeditationsPacks': FieldValue.delete(),
                          },
                        ),
                      });
                ...
                Padding(
                  ...
                  child: FFButtonWidget(
                    onPressed: () async {
                      setState(() {
                        FFAppState().downloadedTracks = [];
                        FFAppState().downloadingTracks = [];
                      });
                      ScaffoldMessenger.of(context).showSnackBar(
                        SnackBar(
                          content: Text(
