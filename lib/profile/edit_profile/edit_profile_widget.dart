              ...
              child: Column(
                ...
                children: [
                                ...
                                return WebViewAware(
                                  child: GestureDetector(
                                    ...
                                    child: Padding(
                                      ...
                                      child: DeleteAccountConfirmWidget(),
                                    ),
                                  ),
                                );
                              },
                  ...
                  Padding(
                    ...
                    child: Container(
                      ...
                      decoration: BoxDecoration(
                        ...
                        borderRadius: BorderRadius.circular(12.0),
                        border: Border.all(
                          color: (_model.surnameFocusNode?.hasFocus ?? false)
                              ? FlutterFlowTheme.of(context).accent1
                              : Colors.transparent,
                        ),
                      ),
                          ...
                          builder: (context) => TextFormField(
                            ...
                            decoration: InputDecoration(
                              ...
                              labelStyle: FlutterFlowTheme.of(context)
                                  ...
                                  .override(
                                    fontFamily: 'Evolventa',
                                    color: (_model.surnameFocusNode?.hasFocus ??
                                            false)
                                        ? FlutterFlowTheme.of(context).accent1
                                        : FlutterFlowTheme.of(context)
                                            .secondaryText,
                              ...
                              focusedErrorBorder: InputBorder.none,
                              suffixIcon:
                                  _model.surnameController!.text.isNotEmpty
                                      ? InkWell(
                                          onTap: () async {
                  ...
                  Padding(
                    ...
                    child: Container(
                      ...
                      decoration: BoxDecoration(
                        ...
                        borderRadius: BorderRadius.circular(12.0),
                        border: Border.all(
                          color: (_model.phoneFocusNode?.hasFocus ?? false)
                              ? FlutterFlowTheme.of(context).accent1
                              : Colors.transparent,
                        ),
                      ),
                          ...
                          builder: (context) => TextFormField(
                            ...
                            decoration: InputDecoration(
                              ...
                              labelStyle: FlutterFlowTheme.of(context)
                                  ...
                                  .override(
                                    fontFamily: 'Evolventa',
                                    color: (_model.phoneFocusNode?.hasFocus ??
                                            false)
                                        ? FlutterFlowTheme.of(context).accent1
                                        : FlutterFlowTheme.of(context)
                                            .secondaryText,
                  ...
                  if (!(isWeb
                    ...
                    Padding(
                      padding:
                          EdgeInsetsDirectional.fromSTEB(0.0, 100.0, 0.0, 46.0),
                      child: InkWell(
                        splashColor: Colors.transparent,
                        focusColor: Colors.transparent,
                        hoverColor: Colors.transparent,
                        ...
                        onTap: () async {
                          await currentUserReference!
                            ...
                            displayName: _model.nameController.text != null &&
                                    _model.nameController.text != ''
                                ? _model.nameController.text
                                : currentUserDisplayName,
                            surname: _model.surnameController.text != null &&
                                    _model.surnameController.text != ''
                                ? _model.surnameController.text
                                : valueOrDefault(
                                    currentUserDocument?.surname, ''),
                            phoneNumber: _model.phoneController.text != null &&
