...
class IsDeletedOnceWidget extends StatefulWidget {
  const IsDeletedOnceWidget({super.key});

  @override
  State<IsDeletedOnceWidget> createState() => _IsDeletedOnceWidgetState();
}

class _IsDeletedOnceWidgetState extends State<IsDeletedOnceWidget> {
  late IsDeletedOnceModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => IsDeletedOnceModel());
  }
